...
#configure mysql remote
app.config['MYSQL_HOST'] = 'localhost'
app.config['MYSQL_USER'] = 'kwatbhmm_kwatcoin'
app.config['MYSQL_PASSWORD'] = 'mayorgnn@088'
app.config['MYSQL_DB'] = 'kwatbhmm_crypto'
...
def buy():
    ...
    if request.method == 'POST':
        ...
        try:
            send_money("KWATCOIN", session.get('username'), form.amount.data)
...
#Index page
@app.route("/minekwatcoin")
def minekwatcoin():
    return render_template('minekwatcoin.html')
